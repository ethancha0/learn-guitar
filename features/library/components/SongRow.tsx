 ...
 *
 * The hairline and the hover wash sit on the wrapper rather than the link,
 * because the delete key is a sibling of the link (a button cannot nest inside
 * an anchor) and the row should still read as one line while it is used.
 */
  ...
  return (
    <div className="group relative border-b border-rule">
      <Link
        ...
        className={cn(
          CATALOGUE_COLUMNS,
          "py-[13px] pl-1 pr-8 text-ink transition-colors group-hover:bg-[var(--wash-soft)] focus-visible:outline focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-accent",
        )}
      >
